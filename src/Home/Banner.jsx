    ...
    <>
      ...
      {/* <nav className="container mx-auto flex justify-between ">
        ...
        <div className="container mx-auto flex flex-col  md:flex-row  lg:flex-row items-center px-4 md:px-0 lg:px-0 py-8 md:py-0 lg:py-0">
          ...
          <div className="">
            ...
            <div className="mb-5 h-12 flex">
              <input
                className="bg-white opacity-25 w-full lg:w-96 px-10 rounded-l-md"
        ...
        {/* --------------------------- */}
          <div>
            <img
              className="md:mx-6 lg:mx-32 md:w-[1500px] lg:w-[1500px] md:h-[410px] lg:h-[720px]"
              src={bannerpic}
              alt=""
            />
            <p></p>
        ...
        {/* ____________________________ */}
        <div className=" flex flex-col md:flex-row lg:flex-row items-center container mx-auto justify-center gap-5 lg:gap-28 py-5 lg:py-20">
          <img src={google} alt="" />
          <img src={slack} alt="" />
          <img src={atlas} alt="" />
          <img src={dropbox} alt="" />
